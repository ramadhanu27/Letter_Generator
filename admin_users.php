            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <a href="admin_users.php" class="text-white border-b-2 border-white px-1 pt-1 pb-4 text-sm font-medium">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            <form method="GET" class="grid md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="admin_users.php" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors">
